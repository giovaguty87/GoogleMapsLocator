...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>  
        ...
        function initialize() {            
            ...
            //debugger;            
            //var service = new google.maps.places.PlacesService(document.getElementById('map_populate'));
            
            //service.getDetails(request, function (place, status) {
            //    if (status === google.maps.places.PlacesServiceStatus.OK) {
                     
            //        var resp = '<div><strong>' + place.name + '</strong><br>' +
            ...
            var contentString = '<div id="content" style="margin-left:15px;margin-top:3px;overflow:hidden;"><div id="bodyContent">' +
                ...
                '<a href="/Default2.aspx?IdW1=' + marker1.position + '" javascript:window.close();style="color:#00303f;font:bold 12px verdana;" title="Send">Send info</a></div>' +
                '</div></div>';
            ...
            var contentString2 = '<div id="content" style="margin-left:15px;margin-top:3px;overflow:hidden;"><div id="bodyContent">' +
                ...
                '<a href="/Default2.aspx?IdW1=' + marker2.position + '"style="color:#00303f;font:bold 12px verdana;" title="Send">Send info</a></div>' +
                '</div></div>';
            ...
            google.maps.event.addListener(marker1, 'click', function () {                
                ...
                window.location.href = "/Default2.aspx?IdW1=" + marker1.position;
            });

            google.maps.event.addListener(marker2, 'click', function () {
                infowindow2.open(diag, marker2);
                window.location.href = "/Default2.aspx?IdW2=" + marker2.position;
            });              
        }
